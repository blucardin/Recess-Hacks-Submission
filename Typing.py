...
text_images_path = ["Images for typing Challenge/Screen Shot 2021-06-26 at 10.55.01 AM.png", "Images for typing Challenge/Screen Shot 2021-06-26 at 11.52.05 AM.png", "Images for typing Challenge/Capture1.PNG", "Images for typing Challenge/capture2.PNG", "Images for typing Challenge/Capture.PNG", "Images for typing Challenge/Capture11.PNG", "Images for typing Challenge/Capture2232e.PNG", "Images for typing Challenge/gyuhawdjik;l.PNG", "Images for typing Challenge/tfgyhawjok.PNG", "Images for typing Challenge/toothpay.PNG", "Images for typing Challenge/ftaguwydjio.PNG", "Images for typing Challenge/fawgjio0kp.PNG", "Images for typing Challenge/wuaijda-.PNG"]
    ...
    class Trypingcommands(commands.Cog):
        ...
        async def Typing_Challenge(self, ctx):
            ...
            self.dict[uid] = {
                "tries" : 0, 
                "starttime" : time.time() , 
                "index" : random.randint(0, (len(text_images_path) - 1))
            }
